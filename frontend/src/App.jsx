...
export default function App() {
  return (
    <div className="min-h-screen bg-white text-slate-800">
      ...
      {/* Hero */}
      <main>
        <section className="bg-gradient-to-r from-primary to-accent/30 text-white py-20">
          <div className="container mx-auto px-4 grid md:grid-cols-2 gap-8 items-center">
            <div>
              <h2 className="text-4xl font-bold mb-4">24/7 Trusted Care at Medicare App</h2>
              <p className="mb-6 text-lg">Personalized medical care with advanced technology and compassionate staff.</p>
              <div className="flex gap-4">
                <button className="bg-white text-primary px-6 py-3 rounded-full font-semibold">Get Started</button>
                <button className="border border-white px-6 py-3 rounded-full">Contact Us</button>
              </div>
            </div>
            <div>
              <img src="https://images.unsplash.com/photo-1550831107-1553da8c8464?auto=format&fit=crop&w=800&q=80" alt="doctor" className="rounded-xl shadow-lg w-full object-cover h-80"/>
            </div>
          </div>
        </section>
