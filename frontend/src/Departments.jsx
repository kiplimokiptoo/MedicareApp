...
const departments = [
  {
    ...
    img: 'https://images.unsplash.com/photo-1580281657527-53bc76d6503d?auto=format&fit=crop&w=1000&q=80'
  },
  {
    id: 'neurology',
    name: 'Neurology',
    desc: "Stroke, epilepsy, migraine, and Parkinson's care.",
    img: 'https://images.unsplash.com/photo-1580281657527-7d9e9fd132df?auto=format&fit=crop&w=1000&q=80'
  },
  {
    id: 'orthopedics',
    name: 'Orthopedics',
    desc: 'Joint replacement, sports injuries, and spine surgery.',
    img: 'https://images.unsplash.com/photo-1511551937903-7883ce1264c8?auto=format&fit=crop&w=1000&q=80'
  },
  {
    id: 'pediatrics',
    name: 'Pediatrics',
    desc: 'Child health, vaccinations, and developmental care.',
    img: 'https://images.unsplash.com/photo-1580281657527-7afd79f47e94?auto=format&fit=crop&w=1000&q=80'
  },
  {
    id: 'dermatology',
    name: 'Dermatology',
  ...
  },
  {
    ...
    img: 'https://images.unsplash.com/photo-1542736667-069246bdbc3d?auto=format&fit=crop&w=1000&q=80'
  },
  {
    id: 'dentist',
    name: 'Dentist',
    desc: 'Dental implants, braces, root canals, and oral hygiene.',
    img: 'https://images.unsplash.com/photo-1588776814546-1f9f6c52e28e?auto=format&fit=crop&w=1000&q=80'
  },
  {
    id: 'eye',
    name: 'Eye Center',
    desc: 'Cataract surgery, LASIK, glaucoma treatment, and vision therapy.',
    img: 'https://images.unsplash.com/photo-1580281657527-1f04f5402966?auto=format&fit=crop&w=1000&q=80'
  }
]
